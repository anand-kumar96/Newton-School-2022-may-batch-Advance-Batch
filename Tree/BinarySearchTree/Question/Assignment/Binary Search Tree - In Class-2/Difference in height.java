...
/
C
if we look over both the tree first one is BST with the maximum possible number of elements 
and the second one can be a binary tree with minimum possible numbers of elements.
